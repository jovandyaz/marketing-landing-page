      ...
      <div className="h-screen bg-gray-200 flex items-center justify-center">
        <ImagesSlider className="h-screen w-screen" images={images}>
          ...
          >
            ...
            <button className="px-4 py-2 backdrop-blur-xs border bg-pink-300/10 border-pink-500/20 text-white mx-auto text-center rounded-full relative mt-4">
              <span>Únete →</span>
              <div className="absolute inset-x-0  h-px -bottom-px bg-linear-to-r w-3/4 mx-auto from-transparent via-pink-500 to-transparent" />
            </button>
          </motion.div>
        </ImagesSlider>
      </div>
